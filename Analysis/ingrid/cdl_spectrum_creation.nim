...
proc main =
  ...
  proc fitAndPlot[T: SomeNumber](h5file: string, tfKind: TargetFilterKind, dKind: DataKind):
    ...
    proc calcfit(dataseq: seq[SomeNumber],
      ...
      let bounds = @[(l: 0.0, u:1000.0),
                     (l: 0.0, u:50.0),
                     (l: 0.0, u:50.0),
                     (l: 1.0, u:300.0),
                     (l: 1.0, u:300.0),
                     (l: 1.0, u:300.0)]
                     #(l: pStart[1]*0.5, u:pStart[1]*1.5),
                     #(l: pStart[2]*0.5, u:pStart[2]*1.5),
                     #(l: -Inf, u:Inf),
                     #(l: -Inf, u:Inf),
